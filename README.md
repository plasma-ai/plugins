...
Plugin marketplaces for [Plasma AI](https://github.com/plasma-ai). Agent
skills for Claude Code and Codex with CLIs published to PyPI.
...
The skill can also be installed straight from its CLI, which copies it
